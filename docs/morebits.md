...
<a name="Morebits.wiki.api.morebitsWikiApiUserAgent"></a>

##### api.morebitsWikiApiUserAgent : <code>string</code>
Custom user agent header, used by WMF for server-side logging.  Set via
[setApiUserAgent](#Morebits.wiki.api.setApiUserAgent).

**Kind**: static property of [<code>api</code>](#Morebits.wiki.api)  
...
Defaults to unused per [consensus](https://en.wikipedia.org/w/index.php?oldid=970618849#Adding_tags_to_Twinkle_edits_and_actions).
...
<table>
  ...
  <tbody>
<tr>
    <td>[ua]</td><td><code>string</code></td><td><p>User agent.</p>
</td>
    </tr>  </tbody>
</table>
...
##### new Morebits.wiki.page(pageName, [currentAction])
...
For the current page, use <code>mw.config.get(&#39;wgPageName&#39;)</code>.</p>
    ...
    <td>[currentAction]</td><td><code>string</code></td><td><p>A string describing the action about to be undertaken.</p>
</td>
    </tr>  </tbody>
</table>
...
<li><code>True</code>: page will be added to the user&#39;s watchlist when <code>save()</code> is called</li>
...
Will first check if the page is queued via [fnProcessTriageList](Morebits.wiki.page~fnProcessTriageList).
...
When functions can't use [fnCanUseMwUserToken](#Morebits.wiki.page..fnCanUseMwUserToken) or
require checking protection, maintain the query in one place. Used
for [delete](#Morebits.wiki.page+deletePage), [undelete](#Morebits.wiki.page+undeletePage), [protect](#Morebits.wiki.page+protect), [stabilize](#Morebits.wiki.page+stabilize), and [move](#Morebits.wiki.page+move) (basically, just not [load](#Morebits.wiki.page+load)).

**Kind**: inner method of [<code>page</code>](#Morebits.wiki.page)  
**Returns**: <code>object</code> - Appropriate token query.  
<table>
  <thead>
    <tr>
      <th>Param</th><th>Type</th><th>Description</th>
...
##### page~fnProcessChecks(action, onFailure, xml) ⇒ <code>boolean</code>
...
<tr>
    ...
    <td>xml</td><td><code>string</code></td><td><p>The response document from the API call.</p>
</td>
    </tr>  </tbody>
</table>
...
- If no tag or regex are provided.
...
given as either as a (regex-valid) string or an array to be joined by pipes.</p>
    ...
    <td>[flags]</td><td><code>string</code></td><td><code>&quot;i&quot;</code></td><td><p>Regex flags to apply.</p>
</td>
    </tr><tr>
...
**Returns**: <code>object</code> - {name: templateName, parameters: {key: value}}.FIXME TODO  
<table>
  <thead>
    <tr>
      <th>Param</th><th>Type</th><th>Default</th><th>Description</th>
...
**Kind**: static constant of [<code>Morebits</code>](#Morebits)  
...
JavaScript translation of the [`IP::sanitizeIP()`](https://gerrit.wikimedia.org/r/plugins/gitiles/mediawiki/libs/IPUtils/+/refs/heads/master/src/IPUtils.php#214)
...
<table>
  ...
  <tbody>
<tr>
    <td>address</td><td><code>string</code></td><td><p>The IPv6 address.</p>
</td>
    </tr>  </tbody>
</table>
...
**Kind**: static method of [<code>Morebits</code>](#Morebits)  
**Returns**: <code>string</code> - - For a page name `Foo bar`, returns the string `[Ff]oo bar`.  
<table>
  <thead>
    <tr>
      <th>Param</th><th>Type</th><th>Description</th>
...
**documentation generated on Fri Nov 20 2020**
